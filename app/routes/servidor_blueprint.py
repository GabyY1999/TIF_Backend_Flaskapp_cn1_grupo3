...
servidor_bp.route('/crear_canal', methods=['POST'])(ServidoresController.crear_canal)
servidor_bp.route('/obtener_canales_servidor/<int:servidor_id>', methods=['GET'])(ServidoresController.obtener_canales_servidor)

servidor_bp.route('/obtener_mensajes_canal/<int:chanel_id>', methods=['GET'])(ServidoresController.obtener_mensajes)
